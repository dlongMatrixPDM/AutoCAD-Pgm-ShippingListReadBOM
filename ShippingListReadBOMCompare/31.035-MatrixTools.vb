...
Namespace MatrixTool
    ...
    Public Class MatrixTools
        ...
        'Dim PrgName, PriPrg, ErrNo, ErrMsg, ErrSource
        ...
        Public Shared AcadApp As AutoCAD.AcadApplication    'Public Shared AcadApp As AutoCAD.AcadApplication    'Dim AcadApp As Object
        Shared XdataType, XdataValue As Object
        Shared Sset As AutoCAD.AcadSelectionSet
        'Public Collction As New Collection
